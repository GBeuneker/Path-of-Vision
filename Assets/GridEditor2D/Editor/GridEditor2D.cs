...
namespace GridEditor2D
{
    public class GridWindow : EditorWindow
    {
        ...
        [MenuItem("Window/GridEditor 2D/Manual")]
        public static void OpenManual()
        {
            Application.OpenURL("https://docs.google.com/document/d/1QwIoZ8N_BU9oJ1qCEJASHn203qJ6fcbKWEwLC53pAqc/edit");
        }

        [MenuItem("Window/GridEditor 2D/Editor")]
        public static void ShowWindow()
        {
            EditorWindow window = EditorWindow.GetWindow(typeof(GridWindow), false, "GridEditor2D");
            window.minSize = new Vector2(245f, 400f);
        }
